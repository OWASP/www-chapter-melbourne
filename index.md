...
## Welcome
Welcome to the Melbourne, Australia chapter.
The Melbourne Chapter's activities are mainly, running meetups, and the AppSec Day conference. We look forward to welcoming you at our events.
...
To be a speaker at the next Melbourne Chapter event, simply message the local chapter leader on [Meetup.com](https://www.meetup.com/Application-Security-OWASP-Melbourne/) with details of the talk. Also, don't forget to follow us on Twitter,
[@OWASPmelbourne](https://twitter.com/OWASPmelbourne) and join the [OWASP Slack team](https://owasp.herokuapp.com/).
